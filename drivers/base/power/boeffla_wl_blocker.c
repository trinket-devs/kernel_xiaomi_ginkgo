			     ...
			     const char * buf, size_t n)
{
	...
	// Store user configured wakelock list and rebuild search string 1.1.0
...
// Show list of default, predefined wakelocks 1.1.0
